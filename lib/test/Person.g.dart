...
Person _$PersonFromJoson(Map<String, dynamic> json) {
  return Person(
...
Map<String, dynamic> _$PersonToJson(Person instance) {
  final val = <String, dynamic>{"firstName": instance.firstName};
    ...
    "GlossDiv": {
      ...
      "GlossList": {
        "GlossEntry": {
          ...
          "Acronym": "SGML",
          "Abbrev": "ISO 8879:1989",
          "GlossDef": {
            "para":
                "A meta-markup language,used to create markup language such as DocBook.",
